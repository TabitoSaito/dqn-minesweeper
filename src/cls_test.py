...
heat_map.append_to_dataset(env, "5x5_on_16x16", repeats=500, kernel_size=2, bombs_per_iter=20, saves_per_iter=20)

heat_map.train("5x5_on_16x16", 1)
heat_map.save("5x5_on_16x16_test")

heat_map.load("5x5_on_16x16_test")
heat_map.evaluate("5x5_on_16x16")
